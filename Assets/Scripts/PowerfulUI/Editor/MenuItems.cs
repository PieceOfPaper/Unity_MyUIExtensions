...
namespace PowerfulUI
{
    public static class MenuItems
    {
        ...
        private static bool IsValidCanvas(Canvas canvas)
        {
            ...
            return UnityEditor.SceneManagement.StageUtility.GetStageHandle(canvas.gameObject) == UnityEditor.SceneManagement.StageUtility.GetCurrentStageHandle();
        }
        ...
        [MenuItem("GameObject/UI/Powerful UI/Button", false, 1)]
