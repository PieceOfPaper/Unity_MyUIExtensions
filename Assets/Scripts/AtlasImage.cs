...
namespace UnityEngine.UI
{
    ...
    [AddComponentMenu("UI/AtrasImage", 11)]
    /// <summary>
    ...
    public class AtlasImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        ...
        [SerializeField] private AtlasWithSpriteDataSet m_Resource;

        public Sprite sprite => m_Resource.atlas == null ? null : m_Resource.atlas.GetSprite(m_Resource.spriteName);

        public SpriteAtlas atlas
        {
            get => m_Resource.atlas;
            set
            {
                if (m_Resource.atlas == value)
                    return;

                m_Resource.atlas = value;
                UpdateSprite();
            }
        }
        ...
        {
            get => m_Resource.spriteName;
            set
            {
                if (m_Resource.spriteName == value)
                    return;

                m_Resource.spriteName = value;
                UpdateSprite();
            }
        }
        ...
        private void UpdateSprite()
        {
            if (sprite != null)
            {
                m_SkipLayoutUpdate = sprite.rect.size == Vector2.zero;
                m_SkipMaterialUpdate = sprite.texture == null;
            ...
            {
                return sprite != null && sprite.texture != null && !GraphicsFormatUtility.IsCrunchFormat(sprite.texture.format) && sprite.texture.isReadable;
            }
        }
        ...
        [SerializeField] private Image.Type m_Type = Image.Type.Simple;
        ...
        /// </remarks>
        public Image.Type type { get { return m_Type; } set { if (SetPropertyUtility_SetStruct(ref m_Type, value)) SetVerticesDirty(); } }
        ...
        /// </summary>
        public bool preserveAspect { get { return m_PreserveAspect; } set { if (SetPropertyUtility_SetStruct(ref m_PreserveAspect, value)) SetVerticesDirty(); } }
        ...
        ///</code>
        /// </example>
        public bool fillCenter { get { return m_FillCenter; } set { if (SetPropertyUtility_SetStruct(ref m_FillCenter, value)) SetVerticesDirty(); } }

        /// Filling method for filled sprites.
        [SerializeField] private Image.FillMethod m_FillMethod = Image.FillMethod.Radial360;
        public Image.FillMethod fillMethod { get { return m_FillMethod; } set { if (SetPropertyUtility_SetStruct(ref m_FillMethod, value)) { SetVerticesDirty(); m_FillOrigin = 0; } } }
        ...
        ///</code>
        /// </example>
        public float fillAmount { get { return m_FillAmount; } set { if (SetPropertyUtility_SetStruct(ref m_FillAmount, Mathf.Clamp01(value))) SetVerticesDirty(); } }
        ...
        ///</code>
        /// </example>
        public bool fillClockwise { get { return m_FillClockwise; } set { if (SetPropertyUtility_SetStruct(ref m_FillClockwise, value)) SetVerticesDirty(); } }
        ...
        ///</code>
        /// </example>
        public int fillOrigin { get { return m_FillOrigin; } set { if (SetPropertyUtility_SetStruct(ref m_FillOrigin, value)) SetVerticesDirty(); } }
        ...
        /// </remarks>
        public bool useSpriteMesh { get { return m_UseSpriteMesh; } set { if (SetPropertyUtility_SetStruct(ref m_UseSpriteMesh, value)) SetVerticesDirty(); } }
...
#if UNITY_EDITOR
                if ((Application.isPlaying || UnityEditor.EditorSettings.spritePackerMode == UnityEditor.SpritePackerMode.SpriteAtlasV2) &&
        ...
        public virtual void OnAfterDeserialize()
        {
            if (m_FillOrigin < 0)
                m_FillOrigin = 0;
            else if (m_FillMethod == Image.FillMethod.Horizontal && m_FillOrigin > 1)
                m_FillOrigin = 0;
            else if (m_FillMethod == Image.FillMethod.Vertical && m_FillOrigin > 1)
                m_FillOrigin = 0;
        ...
        void GenerateTiledSprite(VertexHelper toFill)
        {
            ...
            if (sprite != null && (hasBorder || sprite.packed || sprite.texture != null && sprite.texture.wrapMode != TextureWrapMode.Repeat))
            {
        ...
        void GenerateFilledSprite(VertexHelper toFill, bool preserveAspect)
        {
            ...
            Vector4 outer = sprite != null ? Sprites.DataUtility.GetOuterUV(sprite) : Vector4.zero;
            ...
            {
                if (m_FillAmount < 1f && m_FillMethod != Image.FillMethod.Horizontal && m_FillMethod != Image.FillMethod.Vertical)
                {
        ...
        static List<AtlasImage> m_TrackedTexturelessImages = new List<AtlasImage>();
        ...
        private static void TrackImage(AtlasImage g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(AtlasImage g)
        {
